shared.LoaderTitle = "Apple Hub : LOADING";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://133117911388379",
    Position = UDim2.new(0, 15, 0, 10),
    Size = UDim2.new(0, 50, 0, 50)
});
v4(25, v7);
local v8 = CreateObject("TextLabel", {
    Name = "Apple Hub By Angry Cat",
    Parent = v6,
    BackgroundTransparency = 1,
    Text = "Angry Cat",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id= 84309674603283";
v24.Parent = v23;
...
v16.Home:AddButton({
    Title = "Youtube :AngryCat",
    Description = "Tại đây",
    Callback = function()
        setclipboard("https://youtube.com/@catsay2?si=42QBuR8XQmJ2UrkK");
    end
});
...
local v166 = v16.Sea:AddParagraph({
    Title = "Hoàn Thành Ải Draco V4 (Sớm ra mắt)",
    Content = ""
});
