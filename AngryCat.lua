...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id= 126797166167315";
v24.Parent = v23;
...
v16.Home:AddButton({
    Title = "Discord",
    Description = "TurboLite",
    Callback = function()
        setclipboard("https://discord.com/invite/3xbHPtsQgC");
    end
});
    ...
    v505.RenderStepped:Connect(function()
        ...
        if v594 then
            ...
            if not v513 then
                v14:Notify({
                    Title = "Angry Cat Hub",
                    Content = "Đã Đến Prehistoric Island",
                    Duration = 10
                });
                v513 = true;
            end
    ...
    v505.RenderStepped:Connect(function()
        ...
        if v616 then
            ...
            if not v513 then
                v14:Notify({
                    Title = "Angry Cat Hub",
                    Content = "Đã Đến FrozenDimension",
                    Duration = 10
                });
                v513 = true;
            end
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://80517218846063") then
                    return v729;
                end
            end
        end
...
local v140 = v16.Raid:AddToggle("ToggleNextIsland", {
    Title = "Farm Quái Raid+Bay Đến Đảo",
    Description = "",
    Default = false
});
...
local v146 = v16.Race:AddToggle("ToggleKillTrial", {
    Title = "Farm Người Chơi Trong Trial",
    Description = "",
    Default = false
});
...
local v155 = v16.Sea:AddToggle("ToggleTPFrozenDimension", {
    Title = "Bay Đến Đảo Frozen Dimension",
    Description = "",
    Default = false
});
...
local v166 = v16.Sea: AddButton({
    Title = "Hoàn Thành Ải Draco V4",
    Description = "Dùng Tạm Fly Của TurboLite nha",
    Callback = function()
...
local v167 = v16.Sea:AddToggle("ToggleTrialTeleport", {
    Title = "Bay Đến Chỗ Trial Tộc Draco",
    Description = "",
    Default = false
});
...
v14:Notify({
    Title = "Angry Cat Hub",
    Content = "By Angry Cat",
    Duration = 10
});
------- SOUND

local startupSound = Instance.new("Sound")
    startupSound.SoundId = "rbxassetid://6667923288"
